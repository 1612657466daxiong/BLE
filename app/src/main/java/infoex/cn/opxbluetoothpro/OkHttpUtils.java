...
public class OkHttpUtils<T> {
    ...
    private void initHandler() {
        mHandler = new Handler(OPXApplication.getInstance().getMainLooper()) {
            @Override
            public void handleMessage(Message msg) {
                if (msg!=null&&mListener!=null&&msg.obj!=null){
                    switch (msg.what) {
                        case RESULT_ERROR:
                            Log.e("Http error"," => "+msg.obj==null?msg.toString():msg.obj.toString());

                            mListener.onError("请求数据失败");
                            break;
                        case RESULT_SUCCESS:
                            T result = (T) msg.obj;
     ...
     * @param ：flag
     */
    public OkHttpUtils<T> isBaidu(boolean flag) {
        isBaidu = flag;
        return this;
    }
    ...
    public void execute(OnCompleteListener<T> listener) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                msg.obj = e.getMessage()!=null?e.getMessage():new Message().obj;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if(mClazz.equals(String.class)){
                    ...
                    Gson gson = new Gson();
                    if (json.contains("HTTP Status 404")){
                        Message msg = Message.obtain();
                        msg.what = RESULT_ERROR;
                        msg.obj = "Http 404";
                        mHandler.sendMessage(msg);
    ...
    public static void release() {
        if (mOkHttpClient != null) {
            //取消所有请求
            if (mOkHttpClient.dispatcher()!=null){
